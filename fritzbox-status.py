...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        hostname = 'fritz.box'
    fritz = FritzBox(hostname)
    if fritz.isConnected():
        print('Connected')
    else:
        print('Not connected')
    print('connectTime: ' + str(fritz.connectTime()))
    print('connectDuration: ' + str(fritz.connectDuration()))
    print('wanAddress: ' + str(fritz.wanAddress()))
    print('dnsServer: ' + str(fritz.dnsServer()))
